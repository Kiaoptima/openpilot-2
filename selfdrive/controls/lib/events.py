...
def wrong_car_mode_alert(CP: car.CarParams, sm: messaging.SubMaster, metric: bool) -> Alert:
  text = "Wrong car. Main Switch Off"
  if CP.carName == "honda":
...
def startup_fuzzy_fingerprint_alert(CP: car.CarParams, sm: messaging.SubMaster, metric: bool) -> Alert:
  return Alert(
    "WARNING: There are no exact car models",
...
EVENTS: Dict[int, Dict[str, Union[Alert, Callable[[Any, messaging.SubMaster, bool], Alert]]]] = {
  ...
  EventName.cameraMalfunction: {
    ET.PERMANENT: NormalPermanentAlert("Camera OFF", "Hope you had a nice and relaxed drive!"),
  },
  ...
  EventName.localizerMalfunction: {
    ET.PERMANENT: NormalPermanentAlert("Localizer unstable", "Check device"),
  },
  ...
  EventName.parkBrake: {
    ET.USER_DISABLE: EngagementAlert(AudibleAlert.chimeDisengage),
    ET.NO_ENTRY: NoEntryAlert("release the parking brake"),
  },
  ...
  EventName.processNotRunning: {
    ET.NO_ENTRY: NoEntryAlert("System malfunction: reboot device",
                              audible_alert=AudibleAlert.chimeDisengage),
  },
  ...
  EventName.lowMemory: {
    ET.SOFT_DISABLE: SoftDisableAlert("Out of memory: restart your device"),
    ET.PERMANENT: NormalPermanentAlert("Insufficient memory", "Please reboot device"),
    ET.NO_ENTRY : NoEntryAlert("Out of memory: restart your device",
                               audible_alert=AudibleAlert.chimeDisengage),
  },
  ...
  EventName.controlsMismatch: {
    ET.SOFT_DISABLE: SoftDisableAlert("Controls Mismatch"),
  },
  ...
  EventName.canError: {
    ET.IMMEDIATE_DISABLE: ImmediateDisableAlert("CAN Error: check the device"),
    ET.PERMANENT: Alert(
      "CAN Error: check the device",
      "",
      AlertStatus.normal, AlertSize.small,
      Priority.LOW, VisualAlert.none, AudibleAlert.none, 0., 0., .2, creation_delay=1.),
    ET.NO_ENTRY: NoEntryAlert("CAN Error: check the device"),
  },
