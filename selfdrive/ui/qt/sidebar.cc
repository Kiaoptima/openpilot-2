...
//    pandaStr = "GPS\nSEARCHING";
    ...
    pandaStr = QString("GPS %1\nPOS %2").arg(s.scene.satelliteCount).arg(fmin(10, s.scene.gpsAccuracy), 0, 'f', 2);
