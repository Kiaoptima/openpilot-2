...
DriveStats::DriveStats(QWidget* parent) : QFrame(parent) {
  ...
  auto add_stats_layouts = [=](const QString &title, StatsLabels& labels) {
    ...
    int row = 0;
    grid_layout->addWidget(new QLabel("〔  driving records  〕 \U00002728"), 0, 0, 1, 3, Qt::AlignCenter);
    ...
    grid_layout->addWidget(new QLabel("「 Easy Driving 」"), 11, 0, 1, 3, Qt::AlignCenter);
