...
class CarControllerParams:
  def __init__(self, CP):
    if CP.carFingerprint in [CAR.GRANDEUR, CAR.GRANDEUR_HEV, CAR.GRANDEUR20, CAR.GRANDEUR20_HEV, CAR.K7, CAR.K7_HEV]:
      self.STEER_MAX = 384 # default 255
      self.STEER_DELTA_UP = 3
      self.STEER_DELTA_DOWN = 5
    else:
      self.STEER_MAX = 384 # default 384
      self.STEER_DELTA_UP = 3 # default 3
      self.STEER_DELTA_DOWN = 4 # default 7
...
FEATURES = {
  ...
  "use_fca": # these cars use the [ FCA11 ] message for the AEB and FCW signals, all others use [ SCC12 ]
    set([CAR.SONATA, CAR.PALISADE, CAR.ELANTRA_I30, CAR.ELANTRA21, CAR.KONA, CAR.KONA_HEV, CAR.IONIQ_HEV,
